...
<body>
  <div class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <span class="sm:ml-3">
            <button type="button" class="inline-flex items-center rounded-2xl  bg-white px-3 py-2 text-sm font-semibold text-amber-500 shadow-sm hover:bg-amber-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600">
            Log in
            </button>
          </span>
        </div>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-36 lg:py-46">
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Cloud Hosting</h1>
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">untuk</h1>
          <h1 class="text-4xl font-bold tracking-tight text-amber-600 sm:text-6xl">Kesuksesan Websitemu!</h1></h1>
          <p class="mt-6 text-lg leading-8 text-black">Qwords menawarkan layanan Cloud Hosting yang Cepat, Aman, dan Dukungan 24 jam untuk memenuhi kebutuhan hosting Anda. Tersertifikasi ISO 27001 dengan Data Center Tier 3.</p>
